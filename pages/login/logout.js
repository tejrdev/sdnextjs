      ...
      {login === enc_emailcheck ? (
        <div className='userin df fww'>
          <div className='favheadbtn'>
            <Link href='/favorite' className='ghostbtn font-semibold dark:text-slate-50'>
              ...
              <figure className='pvr'>
                {avatarImage ? <Image src={avatarImage} rel='preload' as='image' title={login} alt='profile' width='35' height='35' style={{ borderRadius: '50px' }} /> :
                  <>
                    ...
                    <Image src={loginprofilewhite} rel='preload' as='image' title={login} width='35' height='35' style={{ borderRadius: '50px' }} alt='profile' className='hidden dark:block' />
                  </>
                }
        ...
        <div className='userin df fww' style={{ display: '' }}>
          ...
          <div className='headsign'>
            <div className='signico'>
              <Link href='/login' title='Sign In' className='dark:border-gold border-2 border-gray-500 rounded-t-full dark:mt-1'>
                <>
                  <figure className="pvr xsm:pt-1 dark:pt-1">
                    <Image src={loginprofile} rel='preload' as='image' title={login} width='35' height='35' style={{ borderRadius: '50px' }} alt='profile' className='dark:hidden' />
                  </figure>
                  <figure className="pvr pt-1">
                    <Image src={loginprofilewhite} rel='preload' as='image' title={login} width='35' height='35' style={{ borderRadius: '50px' }} alt='profile' className='hidden dark:block' />
                  </figure>
                </>
              </Link>
