...
export async function getStaticProps() {
  ...
  const res = await fetch(process.env.NEXT_PUBLIC_SEO_LINK + 'movies');
  ...
  let filmData = await fetch(process.env.NEXT_PUBLIC_SD_API + '/film_data_page/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN);
  filmData = await filmData.json();

  //genre page titles
  let genretitlename = await fetch(process.env.NEXT_PUBLIC_SD_API + '/movie-genre/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN);
