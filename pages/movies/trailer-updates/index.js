                                  ...
                                  <div className='tril_head'>
                                    <h3>
                                      <a href={item.link} title={item.title}>
                                        {item.title}
                                        <span className='font-normal'>{' (' + item.release_year + ')'}</span>
                                      </a>
                                    </h3>
                                    <div className='trialer_duration'>
                                      <div className='flex flex-wrap text-sm mt-1 items-center space-x-2'>
                                        ...
                                        {(item?.primary_genre && item?.primary_genre?.length) && (
                                          <div className='ml-0 mt-2 mb-0 list-none'>
                                            {item?.primary_genre?.map((item, i) => (
                                              <div key={i} className='text-sm inline-block align-top mr-2 mb-2'>
                                                <Link href={item.value} className='cursor-pointer hover:no-underline px-3 rounded-3xl text-black capitalize border border-gray-500 pb-[2px] hover:bg-gray-200 hover:text-black tracking-wide'>
                                                  {item.name}
                                                </Link>
                                              </div>
                                            ))}
