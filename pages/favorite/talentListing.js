          ...
          <div className='top_txt df fww just-between'>
            ...
            <div className='viewmovrebtn df fww'>
              <div className='favaddinput'>
                  ...
                  <div className='favauto' style={hiddenValue}>
                    <ul>
                      {searchData.map((talentSearch, index) => {
                        return (
                          <li key={index + 1} onClick={() => searchSelect(talentSearch.title)}>
                            {talentSearch.title}
                          </li>
                        );
                      })}
                ...
                <button className='btn ' onClick={(e) => addFavoriteTalent('button')}>
                  add{' '}
                </button>
                {loadingFav}
              </div>
              <Link href='/favorite/talent' className='btn goldbtn viewbtnbox'>
                view all
              </Link>
            </div>
          </div>
                      ...
                      <li>
                        <Link href={actor.post_url}>
                          <div
                            ...
                            style={{
                              backgroundImage: `url(${actor?.image_url === process.env.NEXT_PUBLIC_BACKEND_URL + '/wp-content/themes/screendollars-live/assets/images/noactor.svg'
                                  ? Noactorimg.src
                                  : actor?.image_url.replace(/ /g, '%20')
                                })`,
                            }}></div>
                        </Link>
