...
const ContactUs = ({ data, ContactpageData }) => {
  ...
  return (
    <>
      ...
      <section className="contactus my-10 lg:my-16">
        <div className="container">
          <div className="top_txt">
            <h2>{ContactpageData.left_block_title}</h2>
            <h3 className='mb-7 font-semibold'>{ContactpageData.form_content}</h3>
          </div>
          <div className="contactus_row flex flex-wrap flex-col md:flex-row-reverse justify-end ">
            <div className="contact_coltop w-full md:w-[65%]">
              <div className="cnt_img">
                <img rel="preload" as="image" src={ContactpageData.logo} alt={ContactpageData.logo_alt} />
              </div>
              <div className="contact_info flex flex-wrap justify-start pt-5 sm:pt-10">
                {ContactpageData.contact_location.length ? (
                  <div className="cticon_item relative font-semibold max-w-full w-full lg:max-w-60 lg:w-1/3">
                    <a href={ContactpageData.contact_location_link} target="_blank" className='text-black'>
                      <div className="ct_icon mb-5 lg:min-h-14 absolute left-0 top-0 lg:static max-h-12 lg:max-h-full ">
                        <img rel="preload" as="image" src={ContactpageData.location_icon} alt="location" className='max-w-4 sm:max-w-full max-h-7 h-full lg:max-h-full' />
                      </div>
                ...
                {ContactpageData.contact_number.length ? (
                  <div className="cticon_item relative font-semibold max-w-full w-full lg:max-w-60 lg:w-1/3">
                    <a href={ContactpageData.call_link} title="call us" className='text-black'>
                      <div className="ct_icon mb-5 lg:min-h-14 absolute left-0 top-0 lg:static max-h-12 lg:max-h-full ">
                        <img src={ContactpageData.call_icon} alt="call us" rel="preload" as="image" className='max-w-4 sm:max-w-full max-h-7 h-full lg:max-h-full' />
                      </div>
                ...
                {ContactpageData.email_address.length ? (
                  <div className="cticon_item relative font-semibold max-w-full w-full lg:max-w-60 lg:w-1/3">
                    <a href={ContactpageData.email_address_link} className='text-black'>
                      <div className="ct_icon mb-5 lg:min-h-14 absolute left-0 top-0 lg:static max-h-12 lg:max-h-full ">
                        <img rel="preload" as="image" src={ContactpageData.email_address_icon} alt="email us" className='max-w-4 sm:max-w-full max-h-7 h-full lg:max-h-full' />
                      </div>
            ...
            <div className="contact_colbtm w-full pt-5 md:w-[65%] xl:w-[35%] xl:pr-10">
                ...
                <div className="cnt_field mb-5">
                  <span className="wpcf7-form-control-wrap" data-name="your-name">
                    <input
                      ...
                      value={yourname}
                      size="40"
                      className="wpcf7-form-control wpcf7-text placeholder:capitalize"
                ...
                <div className="cnt_field mb-5 commentfield">
                  <span className="wpcf7-form-control-wrap" data-name="your-message">
                    <textarea
                      ...
                      rows="10"
                      value={commentsm}
                      className="wpcf7-form-control wpcf7-textarea max-h-36"
                      placeholder="Question or Comment:"
                      onChange={(e) => setCommentsm(e.target.value)}
                    ></textarea>
                  </span>
                </div>
                <div className="cnt_field mb-5 mt-4 py-3">
