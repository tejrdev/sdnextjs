...
export async function getStaticProps() {
  ...
  const res = await fetch(process.env.NEXT_PUBLIC_SEO_LINK + 'film-data/releases-by-week');
  ...
  const BoxOffice = await fetch(process.env.NEXT_PUBLIC_SD_API + '/film_data_pages/releases-by-week.php?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN);
...
const ReleasesByWeek = ({ data, BOFilterData, BoxOfficeLoadedData }) => {
  ...
  const loadFilterData = (a_year, a_week) => {
    ...
    axios
      .get(process.env.NEXT_PUBLIC_SD_API + '/film_data_pages/releases-by-week.php?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN + '&a_year=' + a_year + '&a_week=' + a_week)
      .then((res) => {
