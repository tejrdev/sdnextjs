...
export async function getStaticProps() {
  ...
  //genre page
  let genretitle = await fetch(process.env.NEXT_PUBLIC_SD_API + '/movie-genre/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN);
  genretitle = await genretitle.json();

  return { props: { SEOdata, homeAPIData, boxOfficeData, genretitle }, revalidate: 20 };
}

export default function HomePage({ SEOdata, homeAPIData, boxOfficeData, genretitle }) {
  ...
  const loadHomeVideos = () => {
    axios
      .get(process.env.NEXT_PUBLIC_SD_API + '/home_video/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN)
      .then((res) => {
  ...
  const loadHomeDirectory = () => {
    axios
      .get(process.env.NEXT_PUBLIC_SD_API + '/home_directory/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN)
      .then((res) => {
  ...
  const loadNowInTheatres = () => {
    axios
      .get(process.env.NEXT_PUBLIC_SD_API + '/home_now_in_theatres/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN)
      .then((res) => {
  ...
  const loadNews = () => {
    axios
      .get(process.env.NEXT_PUBLIC_SD_API + '/home_news/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN)
      .then((res) => {
  ...
  const loadPolls = () => {
    ...
    axios
      .get(process.env.NEXT_PUBLIC_SD_API + '/api_home/poll_quiz.php/?api_token=' + process.env.NEXT_PUBLIC_API_TOKEN + '&ip_address=' + get_user_ips)
      .then((res) => {
                            ...
                            <div className='boftable'>
                              ...
                              <ul id='home_page_boxoffice_data' className=''>
                                <li className='bofrow df fww just-between'>
                                  <h5>
                                    <Link href='/movies/box-office-results/'>Latest Box Office</Link>
                          ...
                          <div className='bofcomedata'>
                            <div className='boftable'>
                              ...
                              <ul id='home_page_boxoffice_data' className=''>
                                <li className='bofrow df fww just-between'>
                                  <h5>
                                    <Link href='/movies/release-calendar/'>Upcoming Wide Releases</Link>
                                    <i className='far fa-angle-right'></i>
                                  </h5>
                                </li>
                      ...
                      <div className='bnrbox_right df fww'>
                        ...
                        <div className='bnrbox_rightinner'>
                          <div className='featurereview'>
                            <div className='top_txt'>
                              <h5>
                                <a href='/movie-reviews/' title='Critics’ Reviews'>
                    ...
                    <div className='seclinespace'>
                      <div className='top_txt df fww just-between'>
                        <div className='secnav df fww'>
                          <h2>
                            <Link href='/movies/' title='Film Data'>
                    ...
                    <div className='moviedbbox df fww just-between'>
                      {boxOfficeData.boxoffice_data && (
                        <div className='moviedbdata'>
                          <div className='moviedbdata_title df fww just-between'>
                            <h5 className='m-0'>
                              <a href='/movies/box-office-results/'>Box Office</a>
                              <i className='far fa-angle-right'></i>
                            </h5>
                      ...
                      {boxOfficeData.boxoffice_upcomming && (
                        <div className='moviedbdata'>
                          <div className='moviedbdata_title df fww just-between'>
                            <h5 className='m-0'>
                              <a href='/movies/release-calendar/'>Coming Soon</a>
                              <i className='far fa-angle-right'></i>
                            </h5>
                          </div>
                          <ul className='grid'>
                        ...
                        <div className='moviedbdata_title df fww just-between'>
                          <h5 className='m-0'>
                            <Link href={genretitle.page_link} className=''>
                              {genretitle.page_title}
                            </Link>
                            <i className='far fa-angle-right'></i>
                          </h5>
                          {
                            <p className='m-0 uppercase'>
                              <Link href={genretitle.page_link} className='blacktxt'>
                                <u>View More</u>
                              </Link>
                            </p>
                          }
