      ...
      <div className='productdetail text-center paywallpvr'>
        ...
        <div className='productdetailbox text-center'>
          <div className='container'>
            ...
            {link !== 'pro' && link !== 'default' ? <iframe src={Pro_data.news_letter_url} frameborder='0' scrolling='no'></iframe> : <iframe src={Pro_data.news_letter_url} frameborder='0'></iframe>}
          </div>
        </div>
        {link !== 'pro' && link !== 'default' && <Paywall />}
      </div>
    </>
  );
}
