      ...
      <div className='container'>
        ...
        {!clamaccshow && (
          <div className={look.claimthanks + ' claimthanks'}>
            ...
            <p>we have received your request to claim your business and we will shortly reach out to you for the verification process on your email or phone.</p>
            {/* <button type='submit' className={look.nexbtn + ' btn uppercase'} onClick={cliamacc_created}>
              CONTINUE
            </button> */}
          </div>
        )}
