      ...
      if (signStatus === 'signup') {
        ...
        const signupGoogle = async () => {
          ...
          if (responseDetails['user_error'] === 1) {
            const SIGN_ALREADY = `Good news!  ${session?.user?.email} has already signed up for Screendollars.  Click here to sign in `;
            ...
            const userTypeLink = responseDetails['type_link'];
