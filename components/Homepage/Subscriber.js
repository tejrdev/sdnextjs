              ...
              <form className={EmailFormClass} noValidate='novalidate' data-status='init'>
                <div className='ftrmail_subscribebox df'>
                  <span className='wpcf7-form-control-wrap' data-name='your-email'>
                    <input type='email' name='your-email' value={NewsLetterEmail} size='40' className='wpcf7-form-control wpcf7-text rounded xsm:rounded-e-none' placeholder='Enter your email' onChange={(e) => onNewsLetterEmailChange(e)} />
                  </span>
                  <input type='hidden' name='form-type' id='form-type' value='newsltr_form' />
                  <button className=' border border-gray-500 border-solid border-l-0 min-w-32 btn xsm:ml-[-1px] xsm:mt-0 mt-1 transition duration-300 ease-out hover:bg-[#b88610] hover:text-white' type='button' title='Sign up to receive the Screendollars Newsletter'>
                    Sign Me Up{' '}
                  </button>
                ...
                <div className='othersubscribes'>
                  ...
                  <label htmlFor='otehrsub'>Add Box Office Forecasts (Wednesdays and Friday)</label>
                </div>
              </form>
            </div>
          </div>
