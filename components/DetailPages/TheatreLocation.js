    ...
    <section className='exb_locationdetail dlsecspace toplinesec'>
      {locationDataLoaded ? (
        <div className='container'>
          ...
          {LocationListData.thealter_pagination && <Pagination setCurrentPage={setCurrentPage} totalPages={Location_listPages} requestFrom='TheatreLocation' currentPage={Location_listPage} />}
        </div>
      ) : (
        <Loader />
      )}
