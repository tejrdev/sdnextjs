...
function Header({ data }) {
  ...
  useEffect(() => {
    ...
    // if ($('.head_right').length > 0) {
    //   var mnusearch = $('.head_right .top_search').html();
    // }
    // if ($('.headtop_left').length > 0) {
    //   var mnusearch = $('.headtop_left .top_search').html();
    // }
    // $('.enumenu_ul').append('<li class="mnusearch"></li>');

    // $('.mnusearch').append(mnusearch);

    $('.mnusearch .custom-select-trigger').on('click', function (e) {
    ...
    $(document).on('.mnusearch .custom-option', 'click', function () {
  ...
  const DynamicHeader = dynamic(() => import('../../pages/login/logout'), {
    ssr: false,
  });
  return (
    <>
      <header id='masthead' className='site-headertop' role='banner'>
        {/* <button className="border p-2 bg-black text-white dark:bg-white dark:text-black transition ease-out duration-75" onClick={darkhandler}>
          <FaMoon />
        </button> */}
        <div className='container'>
          <div className='site-header-mainarea'>
            ...
            <div className='header_topbox df fww'>
              ...
              <div className='headtop_left df fww'>
                <div className='top_search'>
                  <TopSearch />
                </div>
                <div className='userin df fww'>
                  <DynamicHeader />
                  <Link id='redirectLogout' href='/'></Link>
                </div>
              </div>
            </div>
          </div>
