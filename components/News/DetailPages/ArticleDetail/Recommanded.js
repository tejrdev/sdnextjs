              ...
              return (
                <div className='art_sliditem' key={index}>
                  <div className='artslid_infothumb'>
                    <a href={item.link.replace(process.env.NEXT_PUBLIC_BACKEND_URL, '')} title={item.title}>
                  ...
                  <div className='artslid_sortdisc'>
                    <h5>
                        <a href={item.link.replace(process.env.NEXT_PUBLIC_BACKEND_URL, '')} title='Steven Spielberg Gets Personal'>
                        {item.title}
                      </a>
                    </h5>
                    <div className='info_tags'>
                      <ul className='df flex-col'>
                        <li className='spotlight'>{item.cat}</li>
                        {item?.original_source && <li className='personsrc'>{item.original_source}</li>}
