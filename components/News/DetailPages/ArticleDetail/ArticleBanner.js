        ...
        <div className='artdtlbnr_info '>
          ...
          <div className='artdtl_txt text-center'>
            <div className='info_tags artdtltag artbnrtag'>
              <ul className='df fww' dangerouslySetInnerHTML={{ __html: data.get_cat_ttiles }}></ul>
            </div>
            <h1>{data.title}</h1>
          </div>
        </div>
        <div className='vid_caption text-center' dangerouslySetInnerHTML={{ __html: data.img_caption }}></div>
      </div>
    </section>
  );
};
