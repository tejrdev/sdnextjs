      ...
      <div className='weekend-changing-listing--right'>
        <div className='weekend-changing-block'>
          <span className={item.previous_year_data?.color + 'txt weekend-changing--digit pvr'}>
            ...
            <i className={'fas ' + (item.previous_year_data?.color === 'green' ? 'fa-sort-up' : (item.previous_year_data?.color === 'red' ? 'fa-sort-down' : 'fa-minus'))}></i>
          </span>
        ...
        <div className='weekend-changing-block'>
          <span className={item.last_year_data?.color + 'txt weekend-changing--digit pvr'}>
            ...
            <i className={'fas ' + (item.last_year_data?.color === 'green' ? 'fa-sort-up' : (item.last_year_data?.color === 'red' ? 'fa-sort-down' : 'fa-minus'))}></i>
          </span>
