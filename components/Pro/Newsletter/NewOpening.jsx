        ...
        <div className='new-openings--listing'>
          {item.new_opening_movies.map((opening, ind) => {
            return (
              ...
              opening.title && <div className='newsltrlisting df' key={ind}>
                ...
                <div className='newsltrchartinfo'>
                  ...
                  <div className='newschartbox df fww'>
                    <div className='newsltrfilmchart'>
                      <Dailernewschart score={opening.sizzle} height={200} />
                      <p className='text-center'>
                        <strong>Tracking Score</strong>
                        <span className='inforound' title='Tracking Score'>
                          <FiInfo />
                        </span>
                      </p>
                    </div>
                    <div className='newsltrfilmchart'>
                      <Dailernewschart score={opening.adv_ticket} height={200} />
                      <p className='text-center'>
                    ...
                    {/* <div className='newsltrfilmchart'>
                      <Dailernewschart score={opening.awarness} height={200} />
                      <p className='text-center'>
                    ...
                    <div className='newsltrfilmchart'>
                      <Dailernewschart score={opening.intrest} height={200} />
                      <p className='text-center'>
