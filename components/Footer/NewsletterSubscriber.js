  ...
  return (
    <div role="form" className="wpcf7" lang="en-US" dir="ltr">
      ...
      <form method="post" className={EmailFormClass} noValidate="novalidate" data-status="init" id="newsltr_form">
        <div className="ftrmail_subscribe xsm:flex block">
          <span className="wpcf7-form-control-wrap xsm:w-auto w-[100%] inline-block" data-name="your-email">
            <input type="email" id="footer_user_email" name="your-email" value={newsLetterEmail} size="40" className="wpcf7-form-control xsm:max-w-64 rounded xsm:rounded-r-none " placeholder="Enter your email" onChange={(e) => setNewsLetterEmail(e.target.value)} />
          </span>
          <button className="btn xsm:ml-[-1px] xsm:mt-0 mt-1 hover:bg-[#b88610] hover:text-white  w-full xsm:w-auto" type="button" title="Sign up to receive the Screendollars Newsletter" >
            Sign Me Up
          </button>
